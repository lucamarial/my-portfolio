      ...
      <div id='grid-container'>
        <div id='item-text' data-aos='fade-left'>
          ...
          <div id='about-text'>
            ...
            <p>Ever since programming caught my attention, I’ve been feeling the urge to learn about web development. Last year I was living in Stockholm, where I attended a coding Bootcamp for full stack web development. Once there, my interest peaked even further and I got especially hooked on the front-end side of things along with design.</p>
